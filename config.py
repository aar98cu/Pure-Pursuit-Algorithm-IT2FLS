...
control = ["Geometric Lateral Control", "Based on error", "IT2FLS", "T1FLS"]
control_func = None
...
MF_parametros_it2 = np.array([[0.16207, 0.18457, 1.0085, -0.43013, 0.37617],
...
C_parametros_it2 = np.array([[1.6165, 0.043378, 0.3826],
...
"""with dpg.theme(tag="dot_theme"):
    with dpg.theme_component(dpg.mvScatterSeries):
        dpg.add_theme_color(dpg.mvPlotCol_Line, ORIGIN_MARKER_COLOR, category=dpg.mvThemeCat_Plots)
        dpg.add_theme_style(dpg.mvPlotStyleVar_Marker, dpg.mvPlotMarker_Circle, category=dpg.mvThemeCat_Plots)
        dpg.add_theme_style(dpg.mvPlotStyleVar_MarkerSize, ORIGIN_MARKER_SIZE, category=dpg.mvThemeCat_Plots)"""
